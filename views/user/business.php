    ...
    <?php foreach ($userEvents as $event) { ?>
        <div class="col-md-4 col-6">
            <div class="common-card">
                <img class="image" src="/img/eventPhoto/<?php if (!isset($event['eventPhotos'][0]['eventPhoto'])) {
                    echo 'no-photo.png';
                } else {
    ...
    <?php foreach ($userHappenings as $happening) { ?>
        <div class="col-md-6 col-12">
            <div class="common-card" style="height: 150px; overflow: hidden;">
                <img class="image" src="/img/happeningPhoto/<?php if (!isset($happening['happeningPhotos'][0]['happeningPhoto'])) {
                    echo 'no-photo.png';
                } else {
