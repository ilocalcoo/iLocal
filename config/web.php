...
//            'enableStrictParsing' => true,
            ...
            'rules' => [
                ...
                '<controller:(shop)>/<action:(create)>' => '<controller>/create',
...
//                '<controller:(event)>/<action:(create)>' => '<controller>/create-step-1',
                '<controller:(event)>/<action:(create)>' => '<controller>/create',
...
//                '<controller:(event)>s/<id:\d+>/<action:(update/photo)>' => '<controller>/create-step-3',
                '<controller:(happening)>s' => '<controller>/index',
                '<controller:(happening)>s/<id:\d+>' => '<controller>/view',
                '<controller:(happening)>s/<id:\d+>/<action:(view|update|delete)>' => '<controller>/<action>',
                '<controller:(happening)>/<action:(create)>' => '<controller>/create',
//                '<controller:(happening)>/<action:(create)>' => '<controller>/create-step-1',
//                '<controller:(happening)>s/<id:\d+>/<action:(update/info)>' => '<controller>/create-step-2',
//                '<controller:(happening)>s/<id:\d+>/<action:(update/photo)>' => '<controller>/create-step-3',
                ...
                ['class' => 'yii\rest\UrlRule', 'controller' => 'api/shopAddress'],
                ['class' => 'yii\rest\UrlRule', 'controller' => 'api/shoptype'],
                ['class' => 'yii\rest\UrlRule', 'controller' => 'api/eventtype'],
                ['class' => 'yii\rest\UrlRule', 'controller' => 'api/happeningtype'],
                ['class' => 'yii\rest\UrlRule', 'controller' => 'api/happeningphoto'],
